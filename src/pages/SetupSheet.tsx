  ...
  return (
    <main className="page-main shell setup-sheet-page">
      ...
      <section className="setup-sheet paper-sheet">
        ...
        <footer className="paper-sheet__footer"><span>Generated with {PLATFORM_NAME}.</span><span>{venue.isSample ? `Showcase ${eventLabel} data.` : 'Chandelier Oaks setup sheet · final quantities and placement confirmed by venue team.'}</span></footer>
      </section>
    </main>
  )
}
